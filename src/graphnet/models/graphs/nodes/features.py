...
class Percentiles(ClusterFeature):
    ...
    def __init__(
        ...
        Args:
            percentiles (List[int]): Percentiles to compute (e.g., [25, 50, 75]).
            features (List[str]): List of specific features to include.
            use_on_time (bool): Whether to include time as a feature.
            use_all_features (bool): Whether to use all features (without from time).
...
class CumulativeAfterT(ClusterFeature):
    ...
    Attributes:
        times (List[float]): Time thresholds for calculating cumulative values.
    """
    ...
    def __init__(
        ...
        Args:
            times (List[float]): Time points for cumulative calculations.
            features (List[str]): List of features to include (default: []).
            use_all_features (bool): Whether to use all features (without from time).
                To include time set the flag `use_on_time` to True
        """
        super().__init__(
...
class TimeOfPercentiles(ClusterFeature):
    ...
    Attributes:
        percentiles (List[float]): Percentiles to compute times for.
    """
    ...
    def __init__(
        ...
        Args:
            percentiles (List[float]): Percentiles for which to calculate times.
            features (List[str]): List of features to include (default: []).
            use_all_features (bool): Whether to use all features (without from time).
                To include time set the flag `use_on_time` to True
        """
...
class Std(ClusterFeature):
    ...
    def __init__(
        ...
        Args:
            ...
            use_all_features (bool): Whether to use all features (without from time).
                To include time set the flag `use_on_time` to True
            use_on_time (bool): Whether to include time-based features (default: False).
        """
        super().__init__(
            features=features,
            use_on_time=use_on_time,
